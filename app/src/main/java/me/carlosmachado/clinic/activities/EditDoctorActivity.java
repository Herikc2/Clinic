...
public class EditDoctorActivity extends AppCompatActivity {
    ...
    private void select(String id){
        // TODO: Selecionar na tabela "doctor" os dados da view a partir do id
    }

    private void update(String id){
        // TODO: Atualizar na tabela "doctor" os dados da view a partir do id
    }

    private void delete(String id){
        // TODO: Deletar na tabela "doctor" a partir do id
    }
